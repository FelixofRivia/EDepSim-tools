...
INPUT_FILE_PATTERN="/storage/gpfs_data/neutrino/SAND-LAr/SAND-LAr-EDEPSIM-PROD/new-numu-CC-QE-in-GRAIN/grain_numu_ccqe/grain_numu_ccqe_*/skimmed-sand-events.*.edep.root"
